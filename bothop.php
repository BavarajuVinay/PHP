...
?>
	...
	<form name="update_form" action="updt.php" method="post">
	...
	<?php
		...
		<tr>
			<th>Reg.No</th>
			<td><input type="text" name="rn" value=<?php echo $row["regno"] ?> readonly/></td>
		</tr>
		...
		<tr>
			<td colspan="2"><input type="submit" value="Update" align="center"/></td>
		</tr>
	</table>
	</form>
